<?php
	 ...
	 //$archive  = new PHPZip();
	 //$archive->Zip('zipFile', 'zipFile/1.zip');
    ...
    class PHPZip
    {
        ...
        // ------------------------------------------------------ //
        public function Zip($files, $saveName)
        {
            ...
            {
                $this->addFile($file['content'], $file['filename']);
            }
            $out = $this->file();
			return $out;
        ...
        // ------------------------------------------------------ //
        public function ZipAndDownload($files, $zipname='tangram')
        {
            if(@!function_exists('gzcompress')){ return; }
